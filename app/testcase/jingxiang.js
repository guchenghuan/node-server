...
puppeteer.launch(
    ...
    try {
        ...
        await page
            .waitForSelector('.bilibili-player-video-btn-setting-left-videomirror')
            .then(async () => {
                try {
                    const timer = await page.$('.bilibili-player-video-btn-setting-left-videomirror');
                    await timer.click({
                        delay: 1500
                    });
