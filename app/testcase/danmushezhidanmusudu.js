...
puppeteer.launch(
    ...
    try {
        ...
        await page
            .waitForSelector('.bilibili-player-video-danmaku-setting-left-speedplus')
            .then(async () => {
                try {
                    const playtype = await page.$('.bilibili-player-video-danmaku-setting-left-speedplus');
