...
(async function () {  // https://www.bilibili.com/video/BV1154y1m7j1
    try {
        ...
        await driver.sleep(1000)
        let buttonsecai1 = await driver.findElement({ className: 'bilibili-player-video-danmaku-setting-right-fullscreensync' })
        ...
        const results = await driver.executeScript(function () {
            ...
            var result = data.setting_config.fullscreensync;
            return result
        })
        if (results) {
            const owncase = `
