...
(async function () {  // https://www.bilibili.com/video/BV1154y1m7j1
    try {
        ...
        // 获取播放按钮
        let buttonstart = await driver.wait(until.elementLocated(By.className('bilibili-player-iconfont-start')), 3000);
        ...
        // 再次获取播放内部暂停按钮
        let buttonstop = await driver.wait(until.elementLocated(By.className('bilibili-player-video-wrap')), 3000);
